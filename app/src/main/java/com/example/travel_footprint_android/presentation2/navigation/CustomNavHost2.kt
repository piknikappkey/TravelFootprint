...
private fun getDirection(initial: NavPath2, target: NavPath2): Int {
    val initialIndex = NavPathObj2.list.indexOf(initial)
    val targetIndex = NavPathObj2.list.indexOf(target)
