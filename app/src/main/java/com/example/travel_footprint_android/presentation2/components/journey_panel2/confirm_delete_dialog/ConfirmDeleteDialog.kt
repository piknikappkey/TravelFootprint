...
import com.example.travel_footprint_android.presentation2.components.bg_box.BGBox // 通用圆角阴影背景容器
import com.example.travel_footprint_android.presentation2.components.bg_box.BGImgBox // 随机背景图片容器
import com.example.travel_footprint_android.presentation2.components.button.button_delete.ButtonDelete // 删除风格按钮
import com.example.travel_footprint_android.presentation2.components.button.button_save.ButtonSave // 保存风格按钮（此处用作取消按钮）
import com.example.travel_footprint_android.presentation2.components.text.headline.Headline // 标题文字组件
import com.example.travel_footprint_android.presentation2.components.text.text_medium.TextMedium // 正文文字组件
